...
# Observation: Logistic regression performed better than Gaussian Naive Bayes on both datasets
# (Faces: 0.93 vs 0.81 accuracy, Kaktovik: 0.90 vs 0.83), indicating a better fit in PCA space.
